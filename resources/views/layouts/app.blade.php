...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>@yield('title', config('app.name', 'Leonce'))</title>
            ...
            <footer class="bg-gray-900 text-gray-300">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <!-- About -->
                        <div>
                            <h3 class="text-white text-lg font-bold mb-3">Leonce</h3>
                            <p class="text-sm text-gray-400 leading-relaxed">
                                Leonce is your go-to blog for everything about car maintenance, cleaning tech, and industry updates.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="space-y-2 text-sm">
                                ...
                                <li><a href="{{ route('home') }}" class="hover:text-white transition">Blog</a></li>
                    ...
                    <div class="border-t border-gray-800 mt-8 pt-6 text-center text-sm text-gray-500">
                        &copy; {{ date('Y') }} Leonce. All rights reserved.
                    </div>
                </div>
            </footer>
        </div>
